                    ...
                    <form action="<?php echo ('addobatr') ?>">
                        ...
                        <div class="form-outline mb-4">
                            ...
                            <select id="signa_id" class="form_control" name="signa">
                                <option value="" name="bahan_2" hidden selected>-- Pilih Signa --</option>
                        ...
                        <div class="form-outline mb -4">
                            <label class="">Bahan 1<span class="required">*</span></label>
                            <br>
                            <select id="bahan" class="form_control" name="bahan_1">
                                ...
                                <?php
                                foreach ($bahan as $bh) {
                                    echo "<option value='" . $bh['obatalkes_nama'] . "'>" . $bh['obatalkes_nama'] . "</option>";
                                }
                                echo "
		</select>"
                                ?>
                        ...
                        <div class="form-outline mb -4">
                            <label class="">Bahan 2<span class="required">*</span></label>
                            <br>
                            <select id="bahan" class="form_control" name="bahan_2">
                                <option value="" name="bahan_2" hidden selected>-- Pilih Bahan --</option>
                        ...
                        <div class="form-outline mb -4">
                            <label class="">Bahan 3<span class="required">*</span></label>
                            <br>
                            <select id="bahan" class="form_control" name="bahan_3">
                                <option value="" name="bahan_3" hidden selected>-- Pilih Bahan --</option>
